...
; /*
  ...
  */
var $jscomp = $jscomp || {};var $jscomp$this = this;
(function (r) {
  M.anime = r();
})(function () {
  function e(a) {
    ...
    _createClass(FormSelect, [{
      ...
      value: function _setupDropdown() {
        ...
        if (this.searchable) {
          ...
          var element = $('<li class="input-field col s12"><input type="text" class="dropDownsearch" style="width: 96%;"> <label for="first_name">'+ placeholder + '</label></li>');

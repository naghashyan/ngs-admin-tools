<?php
/**
 * AfterLoadEventStructure class, can call after load start
 *
...
class AfterLoadEventStructure extends AbstractEventStructure
{
    private $dto;
    ...
    public static function getEmptyInstance() :AbstractEventStructure {
        return new AfterLoadEventStructure([], null, null);
    }
